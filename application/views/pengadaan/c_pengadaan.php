                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif ?>
                            <form class="form-horizontal" action="<?= base_url('pengadaan/simpan') ?>"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="nama_aset"
                                                placeholder="Masukan Nama Aset.." required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="tujuan_pengadaan" class="col-sm-2 col-form-label">Tujuan
                                            Pengadaan</label>

                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="tujuan_pengadaan"
                                                placeholder="Masukan Tujuan Pengadaan.." required>
                                            <span class="text-danger">*[Contoh: Peremajaan fasilitas unit sarana praktik
                                                siswa]</span>
                                        </div>

                                    </div>
                                    <div class="form-group row"> <label for="sifat_pengadaan"
                                            class="col-sm-2 col-form-label"> Sifat Pengadaan </label>
                                        <div class="col-sm-6"> <select class="form-control" name="sifat_pengadaan"
                                                id="sifat_pengadaan" required>
                                    ...
                                    <div class="form-group row">
                                        <label for="tahun_pengadaan" class="col-sm-2 col-form-label">Tahun
                                            Pengadaan</label>
                                        <div class="col-sm-6">
