...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('src/img/logo/favicon.ico') ?>">
    ...
    <!-- SweetAlert2 -->
    <link rel="stylesheet"
        href="<?= base_url() ?>src/backend/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        ...
                        <?php if ($this->session->userdata('foto') == NULL): ?>
                            <img src="<?= base_url() ?>src/backend/dist/img/profile.png"
                                class="user-image img-circle elevation-2">
                        <?php else: ?>
                            <img src="<?= base_url() ?>src/img/profile/<?= $this->session->userdata('foto') ?>"
                                class="user-image img-circle elevation-2">
                        <?php endif ?>
                        ...
                        <?php if ($this->session->userdata('role') == '1' || $this->session->userdata('role') == '2'): ?>
                            ...
                            <li class="nav-item has-treeview">
                                <a href="<?= base_url('statistik') ?>"
                                    class="nav-link <?= isset($active_menu_statistik) ? $active_menu_statistik : '' ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('aset_wujud') ?>"
                                            class="nav-link <?= isset($active_menu_wujud) ? $active_menu_wujud : '' ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Berwujud</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('aset_dihapuskan') ?>"
                                            class="nav-link <?= isset($active_menu_hapuskan) ? $active_menu_hapuskan : '' ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Dihapuskan</p>
                                        </a>
                                    </li>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('pengajuan') ?>"
                                            class="nav-link <?= isset($active_menu_pnd) ? $active_menu_pnd : '' ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Pengajuan</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('pengadaan') ?>"
                                            class="nav-link <?= isset($active_menu_pgd) ? $active_menu_pgd : '' ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Lihat Data</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item has-treeview">
                                <a href="<?= base_url('monitoring') ?>"
                                    class="nav-link <?= isset($active_menu_mt) ? $active_menu_mt : '' ?>">
                            ...
                            <li class="nav-item has-treeview">
                                <a href="<?= base_url('penyusutan') ?>"
                                    class="nav-link <?= isset($active_menu_pys) ? $active_menu_pys : '' ?>">
