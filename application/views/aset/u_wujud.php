          ...
          <form class="form-horizontal" action="<?= base_url('aset_wujud/ubah') ?>" enctype="multipart/form-data"
            ...
            <div class="card-body">
                ...
                <div class="col-sm-6">
                  <select name="id_barang" class="id_barang form-control" required>
                    ...
                    <?php foreach ($brg as $x): ?>
                      <option <?php if ($x['id_barang'] == $row['id_barang']) {
                                echo 'selected="selected"';
                              } ?> value="<?= $x['id_barang']; ?>"><?= $x['nama_barang']; ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="number" value="<?= $row['volume'] ?>" class="form-control" name="volume"
                    min="0" placeholder="Masukan Volume.." required>
                </div>
              </div>
              <div class="form-group row">
                <label for="satuan" class="col-sm-2 col-form-label">Satuan</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" value="<?= $row['satuan'] ?>" name="satuan"
                    placeholder="Buah/Unit/Lembar.." required>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <select name="kondisi" class="form-control" required>
                    <option value="">- Pilih --</option>
                    <option <?php if ($row['kondisi'] == "Baik") {
                              echo 'selected="selected"';
                            } ?> value="Baik">Baik</option>
                    <option <?php if ($row['kondisi'] == "Renovasi") {
                              echo 'selected="selected"';
                            } ?> value="Renovasi">Renovasi</option>
                    <option <?php if ($row['kondisi'] == "Rusak") {
                              echo 'selected="selected"';
                ...
                <div class="col-sm-6">
                  <select name="id_lokasi" class="form-control" required>
                    ...
                    <?php foreach ($lokasi as $y): ?>
                      <option <?php if ($y['id_lokasi'] == $row['id_lokasi']) {
                                echo 'selected="selected"';
                              } ?> value="<?= $y['id_lokasi']; ?>"><?= $y['nama_lokasi']; ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <div class="input-group mb-3">
                    <input type="number" name="umur_ekonomis" value="<?= $row['umur_ekonomis'] ?>"
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <select name="jenis_bantuan" class="form-control" required>
                    <option value="">- Pilih --</option>
                    <option <?php if ($row['jenis_bantuan'] == 'Yayasan') {
                              echo 'selected="selected"';
                            } ?> value="Yayasan">Yayasan</option>
                    <option <?php if ($row['jenis_bantuan'] == 'Tk') {
                              echo 'selected="selected"';
                            } ?> value="Tk">Tk</option>
                    <option <?php if ($row['jenis_bantuan'] == 'Sd') {
                              echo 'selected="selected"';
                            } ?> value="Sd">Sd</option>
                    <option <?php if ($row['jenis_bantuan'] == 'Smk') {
                              echo 'selected="selected"';
                            } ?> value="Smk">Smk</option>
                    <option <?php if ($row['jenis_bantuan'] == 'BospTK') {
                              echo 'selected="selected"';
                            } ?> value="BospTK">BospTK</option>
                    <option <?php if ($row['jenis_bantuan'] == 'BospSD') {
                              echo 'selected="selected"';
                            } ?> value="BospSD">BospSD</option>
                    <option <?php if ($row['jenis_bantuan'] == 'BospSMK') {
                              echo 'selected="selected"';
                            } ?> value="BospSMK">BospSMK</option>
                    <option <?php if ($row['jenis_bantuan'] == 'Hibah') {
                              echo 'selected="selected"';
                            } ?> value="Hibah">Hibah</option>
                    <option <?php if ($row['jenis_bantuan'] == 'HibahUmum') {
                              echo 'selected="selected"';
                            } ?> value="HibahUmum">HibahUmum</option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" name="generate" id="generate" <?php if ($row['qr_code'] != NULL) {
