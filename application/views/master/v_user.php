...
<div class="content-wrapper">
      ...
      <div class="card-header">
        ...
        <h3 class="card-title">
          <button type="button" data-toggle="modal" data-target="#modal-default"
            class="btn bg-gradient-primary mr-2">Tambah User</button>

          <button type="button" data-toggle="modal" data-target="#modal-import-users"
            class="btn bg-gradient-info mr-2">Import User</button>
  ...
  <!-- /.content -->
  <!-- Modal Import -->
  <div class="modal fade" id="modal-import-users">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?= base_url('users/importUsers') ?>" method="post" enctype="multipart/form-data">
